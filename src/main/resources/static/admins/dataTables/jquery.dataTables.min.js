...
(function (h) {
    ...
    function rb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures,
            g = '<input type="search" class=" layui-input ' + b.sFilterInput + '"/>', j = d.sSearch,
    ...
    var m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    z(o, "aoDrawCallback", g.fnDrawCallback, "login");
                    z(o, "aoServerParams", g.fnServerParams, "login");
                    z(o, "aoStateSaveParams", g.fnStateSaveParams, "login");
                    z(o, "aoStateLoadParams", g.fnStateLoadParams, "login");
                    z(o, "aoStateLoaded", g.fnStateLoaded,
                        "login");
                    z(o, "aoRowCallback", g.fnRowCallback, "login");
                    z(o, "aoRowCreatedCallback", g.fnCreatedRow, "login");
                    z(o, "aoHeaderCallback", g.fnHeaderCallback, "login");
                    z(o, "aoFooterCallback", g.fnFooterCallback, "login");
                    z(o, "aoInitComplete", g.fnInitComplete, "login");
                    z(o, "aoPreDrawCallback", g.fnPreDrawCallback, "login");
                    o.rowIdFn = R(g.rowId);
                    ib(o);
                    var u = o.oClasses;
    ...
    var bb = function (a, b, c, d, e) {
        ...
        }); else if ("templates.admin.telcertification.index" == d || "original" == d) {
            c = 0;
