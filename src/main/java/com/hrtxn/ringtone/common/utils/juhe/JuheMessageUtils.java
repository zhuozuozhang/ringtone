...
/**
 * Author:zcy
 * Date:2019-07-15 9:52
 * Description:聚合短信
 */
@Slf4j
public class JuheMessageUtils {
    ...
    public static void getRequest1(){
        ...
        params.put("key",Constant.MESSAGEKEY);//应用APPKEY(应用详细页查询)
    ...
    //2.发送短信
    public static AjaxResult sendMessage(String mobile, String templateId, HttpSession session){
        String result =null;
        ...
        try {
            ...
            if(object.getInt("error_code")==0){
                ...
                session.setAttribute("timestamp",l);
                log.info("验证码: ---> [{}] 时间戳: ---> [{}]",code,l);
                return AjaxResult.success(true,"短信发送成功，5分钟内有效！");
            }else{
                System.out.println(object.get("error_code")+":"+object.get("reason"));
                return AjaxResult.error(object.get("reason").toString());
            }
        } catch (Exception e) {
            log.error("发送短信 方法：sendMessage 错误信息",e);
    ...
    public static void main(String[] args) {
        sendMessage("15050840350",Constant.UPDATEPASSWORDID,null);
    }
